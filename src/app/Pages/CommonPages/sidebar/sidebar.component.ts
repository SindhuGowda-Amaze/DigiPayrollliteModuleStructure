...
export class SidebarComponent implements OnInit {
  ...
  public EmployeeDashboard() {
    ...
    this.router.navigate(['/hr/EmployeeDashboard']);
  }
  ...
  public Government() {
    ...
    this.router.navigate(['/hr/Government']);
  }
  ...
  public Ammortization() {
    ...
    this.router.navigate(['/hr/MonthlyAmmortizationReport']);
  }
  ...
  public PayRoll() {
    ...
    this.router.navigate(['/hr/PayRollRuns']);
  }
  ...
  public PayrollDashboard() {
    ...
    this.router.navigate(['/hr/PayRollDash']);
  }
  public LOANS() {
    debugger
    this.active = 23;
  ...
  public swal() {
    ...
    `,
      ...
      preConfirm: () => {
        ...
        if (login.value == 4876) {
          location.href = '#/hr/SalaryDetailsDash';
          localStorage.setItem('clickname', 'Staff Salary')
  ...
  public Bankadvicelist() {
    ...
    this.router.navigate(['/hr/BankAdviceList']);
  }
  ...
  public R3Report() {
    ...
    this.router.navigate(['/hr/SSSR3Report']);
  }
  ...
  public Bir1603() {
    ...
    this.router.navigate(['/hr/BIR1603Report']);
  }
  ...
  public Bir1700() {
    ...
    this.router.navigate(['/hr/BIR1700Report']);
  }
  ...
  public Bir1604F() {
    ...
    this.router.navigate(['/hr/BIR1604FReport']);
  }
  ...
  public SSSR5Report() {
    ...
    this.router.navigate(['/hr/SSSR5Report']);
  }
  public sssbreakdown() {
    debugger
    this.active = 'sssbreakdown';
    localStorage.setItem('clickname', 'R5 REPORT')
    this.router.navigate(['/hr/SSSBreakdown']);
  }
  public SSSML1Report() {
    debugger
    this.active = 49;
    localStorage.setItem('clickname', 'ML1 REPORT')
    this.router.navigate(['/hr/SSSML1Report']);
  }
  public SSSRL1Report() {
    debugger
    this.active = 50;
    localStorage.setItem('clickname', 'R1-A REPORT')
    this.router.navigate(['/hr/SSSRL1Report']);
  }
  ...
  public ER2() {
    ...
    this.router.navigate(['/hr/ER2']);
  }
  public RFreport() {
    debugger
    this.active = 54;
    localStorage.setItem('clickname', 'RF-1 Data REPORT')
    this.router.navigate(['/hr/RFReport']);
  }
  public RF1PDF() {
    debugger
    this.active = 55;
    localStorage.setItem('clickname', 'RF-1 PDF REPORT')
    this.router.navigate(['/hr/RF1PDFReport']);
  }
  ...
  public M1mcrf() {
    ...
    this.router.navigate(['/hr/M1MCRFReport']);
  }
  public M1excel() {
    debugger
    this.active = 57;
    localStorage.setItem('clickname', 'M1 - EXCEL')
    this.router.navigate(['/hr/M1ExcelReport']);
  }
  public PagibigSTLRF() {
    debugger
    this.active = 58;
    localStorage.setItem('clickname', 'STLRF')
    this.router.navigate(['/hr/STLRFReport']);
  }
  public PagibigSTLRFExcel() {
    debugger
    this.active = 59;
    localStorage.setItem('clickname', 'STLRF - EXCEL')
    this.router.navigate(['/hr/STLRFExcelReport']);
  }
  ...
  public Bir1601C() {
    ...
    this.router.navigate(['/hr/BIR1601CReport']);
  }
  public Bir1601EQ() {
    debugger
    this.active = 61;
  ...
  public Bir1604C() {
    ...
    this.router.navigate(['/hr/BIR1604CReport']);
  }
  public Bir1604CF() {
    debugger
    this.active = 63;
    localStorage.setItem('clickname', '1604CF')
    this.router.navigate(['/hr/BIR1604CFReport']);
  }
  public Bir2316() {
    debugger
    this.active = 64;
    localStorage.setItem('clickname', '2316')
    this.router.navigate(['/hr/BIR2316Report']);
  }
  ...
  public Leaveconfig() {
    ...
    this.router.navigate(['/hr/LeaveConfigDash']);
  }
  ...
  public EmployeeJobHistory() {
    ...
    this.router.navigate(['/hr/EmploymentJobHistory']);
  ...
  public Holidays() {
    ...
    this.router.navigate(['/hr/HolidayDashboard']);
  ...
  public BirAlphalist() {
    ...
    this.router.navigate(['/hr/BIRAlphaList7']);
  }
  ...
  public expensereport() {
    ...
    this.router.navigate(['/hr/ExpenseReport']);
  ...
  public CUTOFFconfig() {
    ...
    this.router.navigate(['/hr/PayrollCutOffDates']);
  }
  ...
  public Remittance() {
    ...
    this.router.navigate(['/hr/RemittanceConfigDash']);
  }
  ...
  public Overtimesummaryperemployee() {
    ...
    this.router.navigate(['/hr/OverTimeSummaryPerEmployee']);
  }
  public Overtimesummary() {
    debugger
    this.active = 'overtimesummary';
    localStorage.setItem('clickname', 'OVERTIME SUMMARY')
    this.router.navigate(['/hr/OvertimeSummaryReport']);
  }
  ...
  public ModifiedAttendance() {
    ...
    localStorage.setItem('clickname', 'OVERTIME SUMMARY')
    this.router.navigate(['/hr/ModifiedAttendanceReport']);
  }
  ...
  public Generalledger() {
    ...
    this.router.navigate(['/hr/GeneralLedgerReport']);
  }
