...
export class PayslipComponent implements OnInit {
  ...
  onSelect2(event: any) {
    ...
    this.DigipayrollServiceService.ProjectAttachments(this.attachments2)
      .subscribe({
        next: data => {
          debugger
  ...
  public sendmail() {
    ...
    this.DigipayrollServiceService.sendemail(this.tomail, this.subject, this.message)
  ...
  public InsertPayslip() {
    ...
    this.DigipayrollServiceService.InsertPayslip(entity)
