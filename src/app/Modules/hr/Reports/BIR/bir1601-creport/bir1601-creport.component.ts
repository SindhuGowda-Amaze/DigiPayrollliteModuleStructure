    ...
    .subscribe({
      next: (data) => {
        ...
        this.employeelist = data.filter(
          (x) => x.month == this.month && String(x.endyear) == this.Year
        );
        ...
        for (let i = 0; i < this.employeelist.length; i++) {
          this.netMonthSalary += parseFloat(
            this.employeelist[i].netMonthSalary
          );
        }
        for (let i = 0; i < this.employeelist.length; i++) {
        ...
        .subscribe((data) => {
          ...
          (this.companyid = this.companylist[0].id),
            ...
            (this.Address =
              this.companylist[0].address1 + this.companylist[0].address2);
