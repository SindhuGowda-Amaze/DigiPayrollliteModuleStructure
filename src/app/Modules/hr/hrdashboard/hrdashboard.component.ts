...
export class HRDashboardComponent implements OnInit {
  ...
  public getipaddress() {
    debugger
    this.DigiofficeService.getIPAddress().subscribe(data => {
      debugger
      let temap: any = data
  ...
  public GetAnnouncements() {
    debugger
    this.DigiofficeService.GetAnnouncementsByBuildingID(56).subscribe(data => {
      debugger
  ...
  public getDetails() {
    ...
    this.DigiofficeService.GetEmployeeVaccinationDetails().subscribe(data => {
      debugger
  ...
  public GetHolidays() {
    debugger
    this.DigiofficeService.GetHolidays().subscribe(data => {
      debugger
  ...
  public punchout() {
    if (this.punchouttime != undefined) {
      ...
      this.DigiofficeService.GetAttendance().subscribe(data => {
        ...
        this.DigiofficeService.UpdateAttendanceWeb(entity).subscribe(data => {
          if (data != 0) {
