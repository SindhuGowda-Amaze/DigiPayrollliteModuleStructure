...
export class LeaveConfigFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedroute.params.subscribe(params => {
      ...
      if (this.ID == undefined) {
        ...
        this.DigipayrollServiceService.GetLeaveConfiguration().subscribe(
          data => {
            debugger
  ...
  public UpdateHolidays() {
    ...
    this.DigipayrollServiceService.UpdateLeaveConfiguration(entity).subscribe(data => {
  ...
  // public GetLeaveType() {
  //   debugger
  //   this.DigipayrollServiceService.GetLeaveTypeforconfig().subscribe(data => {
  //     debugger
